...
const About = () => {
  return (
    <div className="grid w-full text-center h-screen place-content-center  bg-[#23252A]">
      ...
      <div className="   h-full mt-14 lg:grid lg:place-content-center lg:ml-20 text-white text-xl text-center">
        <p className="mb-14">
...
<div className="lg:flex justify-between w-1/2 lg:w-full  px-8 lg:gap-28 h-full  mt-32 lg:mt-14 mb-4"> 

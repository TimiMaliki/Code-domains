...
const Logo = () => {
  return <div className="lg:w-full h-32 bg-blue-900 flex justify-between items-center lg:p-8">
<img src={Fiverr} alt=""  width={70} height={90}/>
<img src={Github} alt=""  width={90} height={90}/>
<img src={Top} alt=""  width={90} height={90}/>
<img src={Upwork} alt="" width={70} height={90}/>
